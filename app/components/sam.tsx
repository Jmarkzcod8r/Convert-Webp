        ...
        <defs>
          ...
          <symbol id="hamster" data-name="hamster" viewBox="0 0 80 38">
            <g id="hamster-3" data-name="hamster">
              ...
              <path className="hamsterFill" id="body" d="M64 4c-5-4-13-4-16-3l-6 4c-2 1-11 5-25 1-1-1-11-1-15 8a13 13 0 0 0 4 16c25 17 49 4 58-10s2-15 0-16z" />
              <circle className="hamsterFill" id="tail" cx="2" cy="14" r="2" />
              <circle className="hamsterFill" id="ear" cx="45" cy="3" r="3" />
              <path id="eye" d="M55 5a2 2 0 0 1 3 3 2 2 0 0 1-3-3z" className="cls-3" />
            </g>
          </symbol>
        </defs>
        <path
